...
namespace minesmart.DGMS
{
    ...
    public class WebAPIModelResponse
    {
        ...
        public static string UserProfileid { get; set; }
        public static string UserCredtentialId { get; set; }
        ...
        public static string LoginUserEmailId { get; set; }

        public static string IsSubmitsetting { get; set; }
    }
